# Angular Boot Camp example: component-template-testing
...
**[StackBlitz for component-template-testing](https://stackblitz.io/github/AngularBootCamp/component-template-testing)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/component-template-testing.git
cd component-template-testing
npm install
npm start
```
